...
# -*- coding: utf-8 -*-
#
# gauze documentation build configuration file, created by
# sphinx-quickstart on Tue Jun 13 16:39:52 2017.
#
...
project = 'Gauze'
copyright = '2017-2019, Ruslan Baratov, David Hirvonen'
...
latex_documents = [
    (master_doc, 'gauze.tex', 'gauze Documentation',
     'Ruslan Baratov, David Hirvonen', 'manual'),
]
...
man_pages = [
    (master_doc, 'gauze', 'gauze Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gauze', 'gauze Documentation',
     author, 'gauze', 'One line description of project.',
     'Miscellaneous'),
]
